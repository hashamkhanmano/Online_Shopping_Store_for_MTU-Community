...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validate data
    if (empty($product_name) || empty($price) || empty($stock_quantity) || empty($category_id)) {
...
<body>
    <!-- Header with Home, Welcome, and Logout -->
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                <a href="product_dashboard.php" class="btn btn-info">Home</a>
    ...
    <div class="container mt-4">
        ...
        <form action="add_product.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="url" class="form-control" id="image" name="image" placeholder="https://example.com/product.jpg" required>
            </div>
